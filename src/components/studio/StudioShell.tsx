...
export default function StudioShell({
  ...
  // effect — same pattern the old shell used, per React's guidance on
  ...
  const sidebar = (
    <>
      ...
      <nav className="flex-1 overflow-y-auto px-2 py-2" aria-label="Studio sections">
        ...
        <header className="sticky top-0 z-30 flex h-12 shrink-0 items-center gap-2 border-b border-admin-border bg-admin-bg/95 px-3 backdrop-blur">
          ...
          <Menu>
            ...
            <MenuContent>
              ...
              <MenuSeparator />
              <MenuItem asChild>
                <a href={STUDIO_CRM_URL} target="_blank" rel="noreferrer noopener">
